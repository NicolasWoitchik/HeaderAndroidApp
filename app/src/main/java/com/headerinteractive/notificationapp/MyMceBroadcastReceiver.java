...
public class MyMceBroadcastReceiver extends MceBroadcastReceiver {
    ...
    protected static String TAG = MyMceBroadcastReceiver.class.getName();
    ...
    protected void showNotification(Context context, String subject, String message, String action) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context,MCE_SAMPLE_NOTIFICATION_CHANNEL_ID)
                .setSmallIcon(resourcesHelper.getDrawableId("logo"))
